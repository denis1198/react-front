...
export const SidebarMiddleNav = () => (
  <SidebarMenu>
    ...
    >
      ...
      <SidebarMenu.Item title="Files - interessante admin">
      ...
      <SidebarMenu.Item title="Users">
        ...
        <SidebarMenu.Item
          title="Users Grid - painel admin p/cada curso"
          to="/apps/users/grid"
        />
      </SidebarMenu.Item>
      ...
      <SidebarMenu.Item title="Mailbox - terminal de email rota adm">
      ...
      <SidebarMenu.Item title="Profile - perfil individual para cliente">
      ...
      <SidebarMenu.Item
        title="Chat - tornar em chat de suporte?"
        to="/apps/chat"
        exact
      />
    </SidebarMenu.Item>
