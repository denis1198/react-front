...
const Cards = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Saiba mais sobre os concursos passados." />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
      ...
      <Row>
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Default Header</CardTitle>
              <CardTextDemo cardNo="1.01" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
              ...
              <CardBody>
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users201a">
                    <CardTextDemo cardNo="2.01a" />
                  </TabPane>
                  <TabPane tabId="settings201b">
                    <CardTextDemo cardNo="2.01b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
              ...
              <CardBody>
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users202a">
                    <CardTextDemo cardNo="2.02a" />
                  </TabPane>
                  <TabPane tabId="settings202b">
                    <CardTextDemo cardNo="2.02b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
              ...
              <CardBody>
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users203a">
                    <CardTextDemo cardNo="2.03a" />
                  </TabPane>
                  <TabPane tabId="settings203b">
                    <CardTextDemo cardNo="2.03b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
              ...
              <CardBody>
                ...
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users204a">
                    <CardTextDemo cardNo="2.04a" />
                  </TabPane>
                  <TabPane tabId="settings204b">
                    <CardTextDemo cardNo="2.04b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
              ...
              <CardBody>
                ...
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users205a">
                    <CardTextDemo cardNo="2.05a" />
                  </TabPane>
                  <TabPane tabId="settings205b">
                    <CardTextDemo cardNo="2.05b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
              ...
              <CardBody>
                ...
                <UncontrolledTabs.TabContent>
                  <TabPane tabId="users206a">
                    <CardTextDemo cardNo="2.06a" />
                  </TabPane>
                  <TabPane tabId="settings206b">
                    <CardTextDemo cardNo="2.06b" />
                  </TabPane>
                </UncontrolledTabs.TabContent>
              </CardBody>
            </UncontrolledTabs>
      ...
      <Row>
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Pagination</CardTitle>
                <Pagination
                  size="sm"
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Buttons Group</CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Buttons Right</CardTitle>
                <Button outline size="sm" className="ml-auto">
                  Button
                </Button>
              </div>
              <CardTextDemo cardNo="3.04" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Link Right Icon</CardTitle>
                <Button color="link" size="sm" className="ml-auto pt-0">
                  <i className="fa fa-pencil"></i>
                </Button>
              </div>
              <CardTextDemo cardNo="3.06" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Buttons Checkbox</CardTitle>
                <ButtonGroup className="ml-auto" size="sm">
                  <Button outline>All</Button>
                  <Button outline>Videos</Button>
                  <Button outline>Docs</Button>
                </ButtonGroup>
              </div>
              <CardTextDemo cardNo="3.08" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Buttons Radio</CardTitle>
                <ButtonGroup className="ml-auto" size="sm">
                  <Button outline>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Buttons Nesting</CardTitle>
                <ButtonGroup className="ml-auto" size="sm">
                  <Button outline>Prev</Button>
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Right Icon-Left</CardTitle>
                <Button outline size="sm" className="ml-auto">
                  <i className="fa fa-plus mr-2"></i>Button
                </Button>
              </div>
              <CardTextDemo cardNo="3.11" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Right Icon-Right</CardTitle>
                <Button outline size="sm" className="ml-auto">
                  Button<i className="fa fa-copy ml-2"></i>
                </Button>
              </div>
              <CardTextDemo cardNo="3.12" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Right Toolbar Icons Only</CardTitle>
                <ButtonToolbar className="ml-auto">
                  <Button color="primary" size="sm" className="mr-2">
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Dropdown</CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Dropdown Icon</CardTitle>
                <UncontrolledButtonDropdown className="ml-auto">
                  <DropdownToggle size="sm" outline caret>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Button Toolbar</CardTitle>
                <ButtonToolbar className="ml-auto">
      ...
      <Row>
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Right Checkbox</CardTitle>
                <CustomInput
                  type="checkbox"
                  className="ml-auto"
                  id="rightCheckbox"
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Right Checkbox Inline</CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Right Checkbox Empty</CardTitle>
                <CustomInput
                  type="checkbox"
                  className="ml-auto"
                  id="rightCheckboxEmpty"
                  label=""
                />
              </div>
              <CardTextDemo cardNo="4.03" />
            </CardBody>
          </Card>
          {/* END Card */}
          {/* START Card */}
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Right Radio</CardTitle>
                <CustomInput
                  type="radio"
                  className="ml-auto"
                  id="rightRadio"
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                <CardTitle tag="h6">Right Radio Inline</CardTitle>
                <div className="ml-auto d-flex">
                  <CustomInput
                    type="radio"
                    className="mr-3"
                    name="rightRadioInline"
                    id="rightRadioYes"
                    label="Yes"
                  />
                  <CustomInput
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Right Input</CardTitle>
                <Form inline className="ml-auto">
                  <FormGroup>
                    <Input
                      type="text"
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-3">
                <CardTitle tag="h6">Right Input Addon</CardTitle>
                <Form inline className="ml-auto">
                  <FormGroup>
                    <InputGroup size="sm">
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <Row className="mb-2">
                <Col lg={6}>
                  <CardTitle tag="h6">Right Progressbar</CardTitle>
                </Col>
                <Col lg={6} className="text-right">
                  <Progress value={25}>25%</Progress>
                </Col>
              </Row>
              <CardTextDemo cardNo="5.01" />
            </CardBody>
          </Card>
          {/* END Card */}
        </Col>
