  ...
  <React.Fragment>
    <Container>
      ...
      <Row>
        <Col lg={3}>
          <Card className="mb-3">
            <CardHeader tag="h6">Default Card</CardHeader>
            <CardBody>{cardText({ cardNo: "1.01" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader tag="h6">White Card</CardHeader>
            <CardBody>{cardText({ cardNo: "1.02" })}</CardBody>
          </Card>
          <Card className="mb-3">
          ...
          <Card className="mb-3">
            ...
            <CardBody>{cardText({ cardNo: "1.05" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader tag="h6" className="bg-success text-white">
              Success Card
            </CardHeader>
            <CardBody>{cardText({ cardNo: "1.06" })}</CardBody>
          </Card>
        </Col>
        <Col lg={3}>
          <Card className="mb-3" shadow="shadow">
            ...
            <CardBody>{cardText({ cardNo: "1.07" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader tag="h6" className="bg-danger text-white">
              Danger Card
            </CardHeader>
            <CardBody>{cardText({ cardNo: "1.08" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader tag="h6" className="bg-dark text-white">
              Dark Card
            </CardHeader>
            <CardBody>{cardText({ cardNo: "1.09" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader tag="h6" className="bg-facebook text-white">
              Facebook Card
            </CardHeader>
            <CardBody>{cardText({ cardNo: "1.10" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Without Header
                <span className="small ml-1">Optional</span>
              </CardTitle>
      ...
      <Row>
        ...
        <Col lg={6}>
          <Card type="border" color="success" className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Success Border Card</CardTitle>
              {cardText({ cardNo: "2.05" })}
            </CardBody>
          </Card>
          <Card type="border" color="warning" className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Warning Border Card</CardTitle>
              {cardText({ cardNo: "2.01" })}
            </CardBody>
          </Card>
          <Card type="border" color="danger" className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Danger Border Card</CardTitle>
              {cardText({ cardNo: "2.01" })}
            </CardBody>
          </Card>
          <Card type="border" color="facebook" className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Facebook Border Card</CardTitle>
              {cardText({ cardNo: "2.01" })}
            </CardBody>
          </Card>
        </Col>
      ...
      <Row>
        <Col lg={6}>
          <Card className="mb-3">
            ...
            <CardBody>{cardText({ cardNo: "4.01" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader type="border" color="primary" tag="h6">
              Bottom Primary Border
            </CardHeader>
            <CardBody>{cardText({ cardNo: "4.02" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader type="border" color="secondary" tag="h6">
              Bottom Secondary Border
            </CardHeader>
            <CardBody>{cardText({ cardNo: "4.03" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader type="border" color="success" tag="h6">
              Bottom Success Border
            </CardHeader>
            <CardBody>{cardText({ cardNo: "4.04" })}</CardBody>
          </Card>
          <Card className="mb-3">
            <CardHeader type="border" color="info" tag="h6">
              Bottom Info Border
            </CardHeader>
            <CardBody>{cardText({ cardNo: "4.05" })}</CardBody>
          </Card>
        </Col>
        <Col lg={6}>
          <Card className="mb-3">
      ...
      <Row>
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">White Background</CardTitle>
      ...
      <Row>
        <Col lg={6}>
          <Card className="mb-3 bg-none">
            <CardBody>
              <CardTitle tag="h6">Without Background</CardTitle>
              {cardText({ cardNo: "6.01" })}
            </CardBody>
          </Card>
          <Card className="mb-3" type="border-dash">
            <CardBody>
              <CardTitle tag="h6">Dashed Border Card</CardTitle>
              {cardText({ cardNo: "6.02" })}
            </CardBody>
          </Card>
          <Card className="mb-3" type="shadow">
            <CardBody>
              <CardTitle tag="h6">Shadow Custom</CardTitle>
        ...
        <Col lg={6}>
          <Card className="mb-3 bg-none" type="border-dot">
            <CardBody>
              <CardTitle tag="h6">Dotted Border Card</CardTitle>
              {cardText({ cardNo: "6.04" })}
            </CardBody>
          </Card>
          <Card className="mb-3" type="none">
            <CardBody>
              <CardTitle tag="h6">Without Border & Background Card</CardTitle>
